        ...
        <div className="w-auto h-auto flex justify-center flex-col items-center">
          ...
          <div className="w-full h-auto flex  gap-2 justify-center items-center">
            <button
              ...
              className="focus:outline-none mt-3  text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
            >
              Edit
            </button>
            <button
